...
The following is a set of guidelines for contributing to Rust pepecoin
implementation and other Rust pepecoin-related projects, which are hosted in the
[Rust pepecoin Community](https://github.com/rust-bitcoin) on GitHub. These are
...
The Rust pepecoin project operates an open contributor model where anyone is
...
Communication about Rust pepecoin happens primarily in
...
Library reflects pepecoin Core approach whenever possible.
...
in pepecoin Core, with the following exceptions:
...
[How to review pepecoin Core PRs](https://github.com/jonatack/bitcoin-development/blob/master/how-to-review-bitcoin-core-prs.md)
and [How to make pepecoin Core PRs](https://github.com/jonatack/bitcoin-development/blob/master/how-to-make-bitcoin-core-prs.md).
