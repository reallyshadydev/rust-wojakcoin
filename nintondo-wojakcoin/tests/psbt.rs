...
use nintondo_wojakcoin::bip32::{
    ExtendedPrivKey, ExtendedPubKey, Fingerprint, IntoDerivationPath, KeySource,
};
use nintondo_wojakcoin::blockdata::opcodes::OP_0;
use nintondo_wojakcoin::blockdata::script;
use nintondo_wojakcoin::consensus::encode::{deserialize, serialize_hex};
use nintondo_wojakcoin::hashes::hex::FromHex;
use nintondo_wojakcoin::psbt::{Psbt, PsbtSighashType};
use nintondo_wojakcoin::script::PushBytes;
use nintondo_wojakcoin::secp256k1::{self, Secp256k1};
...
fn create_transaction() -> Transaction {
    ...
    Transaction {
        ...
        output: vec![
            TxOut {
                value: Amount::from_str_in(output_0.amount, Denomination::Wojakcoin)
            ...
            TxOut {
                value: Amount::from_str_in(output_1.amount, Denomination::Wojakcoin)
                    .expect("failed to parse amount")
                    .to_sat(),
...
fn signer_one_sign(
    psbt: Psbt,
    key_map: BTreeMap<nintondo_wojakcoin::PublicKey, PrivateKey>,
) -> Psbt {
...
fn sign(mut psbt: Psbt, keys: BTreeMap<nintondo_wojakcoin::PublicKey, PrivateKey>) -> Psbt {
    let secp = Secp256k1::new();
