...
use nintondo_wojakcoin::bip32::{ChildNumber, ExtendedPrivKey, ExtendedPubKey, KeySource};
use nintondo_wojakcoin::blockdata::locktime::{absolute, relative};
use nintondo_wojakcoin::blockdata::witness::Witness;
use nintondo_wojakcoin::consensus::encode::deserialize;
use nintondo_wojakcoin::hashes::hex::FromHex;
use nintondo_wojakcoin::hashes::{hash160, ripemd160, sha256, sha256d, Hash};
use nintondo_wojakcoin::psbt::raw::{self, Key, Pair, ProprietaryKey};
use nintondo_wojakcoin::psbt::{Input, Output, Psbt, PsbtSighashType};
use nintondo_wojakcoin::sighash::{EcdsaSighashType, TapSighashType};
use nintondo_wojakcoin::taproot::{self, ControlBlock, LeafVersion, TapTree, TaprootBuilder};
use nintondo_wojakcoin::{
...
fn serde_regression_address() {
    ...
    let addr = Address::p2pkh(&pk, Network::Wojakcoin);
