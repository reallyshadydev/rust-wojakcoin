...
//! Partially Signed pepecoin Transactions.
//!
//! Implementation of BIP174 Partially Signed pepecoin Transaction Format as
...
/// The various output types supported by the pepecoin network.
...
/// Signing algorithms supported by the pepecoin network.
#[derive(Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Hash)]
...
mod tests {
    ...
    fn serialize_then_deserialize_output() {
        ...
        let mut sk: ExtendedPrivKey = ExtendedPrivKey::new_master(Wojakcoin, &seed).unwrap();
