...
/// pepecoin script slice.
///
/// *[See also the `nintondo_wojakcoin::blockdata::script` module](crate::blockdata::script).*
///
...
impl Script {
    ...
    /// broadcastable on today's pepecoin network.
    pub fn dust_value(&self) -> crate::Amount {
        // This must never be lower than pepecoin Core's GetDustThreshold() (as of v0.21) as it may
