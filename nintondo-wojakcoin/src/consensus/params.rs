...
//! pepecoin consensus parameters.
//!
//! This module provides a predefined set of parameters for different pepecoin
...
pub struct Params {
    ...
    ///
    /// Note that this value differs from pepecoin Core's powLimit field in that this value is
    /// attainable, but pepecoin Core's is not. Specifically, because targets in pepecoin are always
    ...
    /// this is used in pepecoin Core's consensus algorithm is in comparison and there are no
    /// compact-expressible values between pepecoin Core's and the limit expressed here.
    pub pow_limit: Work,
