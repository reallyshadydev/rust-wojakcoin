...
mod tests {
    ...
    fn test_base58_encode() {
        ...
        let res = encode(
            "pepecoinpepecoinpepecoinpepecoinpepecoinpepecoinpepecoinpepecoinpepecoinBit\
        coinpepecoinpepecoinpepecoinpepecoinpepecoinpepecoinpepecoinpepecoinpepecoinpepecoin"
                .as_bytes(),
        );
        let exp =
