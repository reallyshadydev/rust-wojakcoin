...
mod newtypes {
    ...
    hash_newtype! {
        ...
        ///
        /// For compatibility with the existing pepecoin infrastructure and historical
        /// and current versions of the pepecoin Core software itself, this and
        ...
        /// A hash of pepecoin Script bytecode.
        pub struct ScriptHash(hash160::Hash);
        /// SegWit version of a public key hash.
        pub struct WPubkeyHash(hash160::Hash);
        /// SegWit version of a pepecoin Script bytecode hash.
