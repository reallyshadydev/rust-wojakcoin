...
// Copyright (c) 2009-2018 The pepecoin Core developers
...
//!
//! ```rust
//! use nintondo_wojakcoin::hash_types::Txid;
//! use nintondo_wojakcoin::hashes::hex::FromHex;
//! use nintondo_wojakcoin::{Block, MerkleBlock};
//!
...
//! let mb: MerkleBlock = nintondo_wojakcoin::consensus::deserialize(&mb_bytes).unwrap();
//!
...
impl MerkleBlock {
    ...
    /// let block: Block = nintondo_wojakcoin::consensus::deserialize(&block_bytes).unwrap();
    ///
...
impl PartialMerkleTree {
    ...
    /// use nintondo_wojakcoin::hash_types::Txid;
    /// use nintondo_wojakcoin::hashes::hex::FromHex;
    /// use nintondo_wojakcoin::merkle_tree::{MerkleBlock, PartialMerkleTree};
    ///
    /// // Block 80000
    /// let txids: Vec<Txid> = [
