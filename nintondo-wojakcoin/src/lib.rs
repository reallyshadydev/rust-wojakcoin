...
//! # Rust Wojakcoin Library
//!
//! This is a library that supports the Wojakcoin (WJK) network protocol and associated
//! primitives. It is designed for Rust programs built to work with the Wojakcoin
//! network.
//!
