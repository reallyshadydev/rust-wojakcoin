...
//! needed by pepecoin. These are SHA256, SHA256d, and RIPEMD160. As an ancillary
    ...
    + borrow::Borrow<[u8]>
{
    ...
    /// it, however it is used in various places in pepecoin e.g., the pepecoin genesis block's
